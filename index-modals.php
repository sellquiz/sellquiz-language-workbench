...
<div class="modal fade" id="createDocumentModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDocumentModalLabel">Create a new Document</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
            <div class="form-group">
                <!-- Order -->
                <label for="createDocumentModalOrder">Document Order (used for sorting):</label>
                <input type="text" class="form-control" id="createDocumentModalOrder" placeholder="0">
                <br/>
                <!-- ID -->
                <label for="createDocumentModalId">Document ID:</label>
                <input type="text" class="form-control" id="createDocumentModalId" placeholder="document ID">
                <br/>
                <!-- description -->
                <label for="createDocumentModalDesc">Document Description:</label>
                <input type="text" class="form-control" id="createDocumentModalDesc" placeholder="optional">
                <br/>
                <!-- submit button -->
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="slwEditor.createDocument();">Create</button>
            </div>
            </div>
            <div class="modal-footer">
