var slwEMU = (() => {
  ...
  var _Part = class {
    constructor(coursePage2) {
      ...
      this.pageIdx = coursePage2.getNumPages() - 1;
    }
    ...
    createHtmlElement() {
      ...
      switch (this.type) {
        case "text-field" /* TextField */:
          ...
          this.htmlFeedbackElement.innerHTML = '&nbsp;&nbsp;<i class="fas fa-question"></i>';
  ...
  var PartQuestion = class extends Part {
    ...
    generateInputElements() {
      for (let i = 0; i < this.inputFields.length; i++) {
        ...
        const inputFieldSpan = document.getElementById(this.getHtmlElementIdx(i));
    ...
    generate(rootElement) {
      ...
      for (let i = 0; i < this.inputFields.length; i++) {
        text = text.replace("$" + i + "$", '<span id="' + this.getHtmlElementIdx(i) + '"></span>');
      }
      const divContainer = document.createElement("div");
      this.htmlElement = divContainer;
    ...
    import(data) {
      ...
      for (let i = 0; i < data["input-field-types"].length; i++) {
        ...
        inputField.answerVariable = this.getVariable(data["input-field-answers"][i]);
      }
    }
  };
  ...
  var PartSpeedReview = class extends Part {
    ...
    generate(rootElement) {
      ...
      this.htmlContentElement.innerHTML = '<span style="font-size: 48pt"><i class="fas fa-play-circle"></i></span>';
      divCol.appendChild(this.htmlContentElement);
      divCol.addEventListener("click", () => {
        const q = this.questions[1];
        this.htmlContentElement.innerHTML = `
                <div class="row py-0">
                    <div class="col text-center py-0">
                        <p class="lead py-0">` + q.text + `</p>
                    </div>
                </div>
    ...
    refreshProgressBars() {
      ...
      div.innerHTML = `
        <div id="text-progress" class="progress">
            <div class="progress-bar" role="progressbar" style="width: ` + this.textProgress + `%; background-color:#cd121b;" aria-valuenow="` + this.textProgress + `" aria-valuemin="0" aria-valuemax="100">Text</div>
        </div>
        <div class="progress">
