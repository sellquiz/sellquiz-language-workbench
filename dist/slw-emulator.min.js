var slwEMU = (() => {
  ...
  var PartSpeedReview = class extends Part {
    ...
    generate(rootElement) {
      ...
      this.htmlElement.innerHTML = '<span style="font-size: 48pt"><i class="fas fa-play-circle"></i></span>';
    ...
    refreshProgressBars() {
      ...
      div.innerHTML = `
        <div id="text-progress" class="progress">
            <div class="progress-bar bg-dark" role="progressbar" style="width: ` + this.textProgress + `%" aria-valuenow="` + this.textProgress + `" aria-valuemin="0" aria-valuemax="100">Text</div>
        </div>
        <div class="progress">
